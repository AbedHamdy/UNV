...
@section('title', 'Edit Levels Count')
@section('content')
    <div class="content" id="mainContent">
        <div class="container"
            ...
            <h2 style="text-align:center; color: #c0392b; margin-bottom: 18px; font-weight: bold;">
                Edit Levels Count for Category: {{ $category->name }}
            </h2>
            ...
            <form method="POST" action="{{ route('update_level', $category->id) }}">
                @csrf
                @method('PUT')
                <div style="margin-bottom: 18px;">
                    <label for="levelsCount" style="display:block; color:#111; font-weight:500; margin-bottom:6px;">
                        Levels Count
                    </label>
                    <input type="number" id="levelsCount" name="levels_count" value="{{ old('levels_count', $levelsCount) }}" min="0" required
